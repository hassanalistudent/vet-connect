...
const PetOwnerAppointments = () => {
  ...
  const [sortOrder, setSortOrder] = useState("newest"); // urgent, oldest, newest
  ...
  const getUrgencyBadge = (appointmentDate, status) => {
    ...
    if (diffDays < 0) {
      return <span className="text-xs bg-red-100 text-red-700 px-2 py-1 rounded-full">Overdue By Doctor</span>;
    } else if (diffDays === 0) {
  ...
  // Get doctor specialization display
  const getDoctorSpecialization = (doctor) => {
    if (!doctor) return "Veterinarian";
    if (doctor.specialization) return doctor.specialization;
    if (doctor.doctorProfile?.specialization) return doctor.doctorProfile.specialization;
    return "Veterinarian";
  };
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-3 space-y-2">
                            ...
                            <div className="flex items-center text-sm text-gray-600">
                              ...
                              <span>
                                Dr. {appt.doctorId?.fullName || "Unknown Doctor"}
                                <span className="text-gray-500 ml-1">
                                  • {getDoctorSpecialization(appt.doctorId)}
                                </span>
                              </span>
                            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mt-8">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-100">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-purple-600">Pending Response</span>
                ...
                <div className="pt-1">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-red-600">Overdue From Doctor</span>
                    <span className="font-semibold">
                      {appointments.filter(a => 
